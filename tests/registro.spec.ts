...
test('TC-03 verificar que el boton de registro se habilita al completar los campos', async ({page}) =>{
  ...
  await registerPage.completarFormularioRegistro('luis', 'guerra', 'luisfernadogv@gmail.com', '123456789')
...
//   await expect(page.getByText('Registro exitoso!')).toBeVisible({timeout:10000});
  ...
  await registerPage.completarYhacerClickBotonRegistro('luis','guerra', email, '123456789')
  await expect(page.getByText('Registro exitoso!')).toBeVisible({timeout:10000});
